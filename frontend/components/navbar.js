...
<meta charset="utf-8"></meta>
  ...
  <div class="container-fluid" >
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
               <Link href="/detail"><a class="nav-link active"> ประเภทหนังสือ </a></Link> 
            </li>
            <li class="nav-item">
               <Link href="/shops"><a class="nav-link active"> รายการหนังสือ </a></Link> 
            </li>
            <li class="nav-item">
            ...
            <div className={styles.dropdown}>
                <span>
                   <a class="nav-link active">วิธีการยืมออนไลน์</a> 
                </span>
